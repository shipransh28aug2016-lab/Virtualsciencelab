...
export function measure(state, inputs, seed = 1, trial = 1) {
   ...
   */
  if (!state || !state.settled) return { v: null, reason: 'The solvent front has not finished rising. Let the chromatogram run until the front is near the top of the paper, then take it out, mark the front, and measure the spots.' };
