...
export function measure(state, inputs, seed = 1, trial = 1) {
   ...
   */
  if (!state || !state.settled) return { v: null, reason: 'The meter has not settled. Touch the probes to the component, wait for the reading to hold, and then record it.' };
